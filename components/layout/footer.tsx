...
export function Footer() {
  ...
  <div className="flex space-x-4 mt-6">
    {/* Discord */}
    <a href="https://discord.gg/g8jaWU2x" className="text-gray-400 hover:text-cyberpunk-cyan transition-colors" aria-label="Discord">
    ...
    {/* Twitter */}
    <a href="https://twitter.com/tradearmadex?s=11" className="text-gray-400 hover:text-cyberpunk-cyan transition-colors" aria-label="Twitter">
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    {/* Telegram */}
    <a href="#" className="text-gray-400 hover:text-cyberpunk-cyan transition-colors" aria-label="Telegram">
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
