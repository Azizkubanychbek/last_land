...
const tokenomicsData = [
  { name: 'Liquidity Incentives', value: 15, color: 'hsl(var(--chart-1))' },
  { name: 'Protocol-Owned Liquidity (POL)', value: 10, color: 'hsl(var(--chart-2))' },
  { name: 'Staking & Validator Rewards', value: 20, color: 'hsl(var(--chart-3))' },
  { name: 'Community Rewards & Airdrop', value: 10, color: 'hsl(var(--chart-4))' },
  { name: 'Private + Strategic Sale', value: 10, color: 'hsl(var(--chart-5))' },
  { name: 'Team and Advisors', value: 10, color: 'hsl(240, 70%, 45%)' }, // Changed color for variety
  { name: 'DAO Treasury', value: 20, color: 'hsl(180, 70%, 45%)' },
  { name: 'Public Sale (Launchpad)', value: 5, color: 'hsl(60, 70%, 45%)' }, // Added new item and color
];
